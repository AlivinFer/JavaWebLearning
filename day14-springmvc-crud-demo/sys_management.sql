...
--
-- Host: localhost    Database: sys_management
-- ------------------------------------------------------
...
CREATE DATABASE `sys_management`;
...
INSERT INTO `sys_role` VALUES (1,'院长','负责全面工作'),(2,'研究员','课程研发工作'),(3,'讲师','授课工作'),(4,'助教','协助解决学生的问题');
...
--
-- Dumping routines for database 'sys_management'
--
...
-- Dump completed on 2025-03-29 23:18:09
